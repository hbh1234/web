<!--
 * @FileDescription: 修改密码
 * @Author: hbh
 * @Date: 2021-02-05
 -->
<template>
  <div class="register change-password">
    <h2 class="account-seting-title">修改密码</h2>
    <div class="change-password-step">
      <hzw-steps :data="steps" :active="currentStep"></hzw-steps> 
    </div>
    <div class="change-password-from-wrap">
      <!-- step 1 手机验证 -->
      <el-form
        :model="formPhone"
      ...
      <!-- step 3 绑定邮箱 -->
      <div class="change-password-register-success" v-show="currentStep === 2">
        <img
          class="change-password-success__pic"
